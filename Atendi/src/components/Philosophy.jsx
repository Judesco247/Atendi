...
const Philosophy = () => (
  <div class="md:container mx-auto mt-10">
    <div class="">
      ...
      <p class="lg:ml-0 md:ml-28 ml-6 lg:w-[932px] md:w-[530px] w-[350px] lg:h-[52px] md:h-[70px] h-[104px] text-center text-color2 text-[13px] font-bodyfont-700 mt-5">
      ...
      <div className="lg:ml-20 ml-6 container mx-auto md:grid grid-cols-3 gap-5 md:mt-10 mt-5 ">
