...
const Philosophy = () => (
    <div class="md:container mx-auto mt-10">
        <div class="">
            <h1 class="text-center text-color1 text-[25px] font-bold font-kollektif-700 mt-4">Our Philosophy</h1>
            <p class="md:ml-36 ml-6 md:w-[932px] w-[350px] md:h-[52px] h-[104px] text-center text-color2 text-[13px] font-kollektif-700 mt-5">As a technology-led company, information is at our core. We are continually thinking about solutions that positively impact customer relationships of ours and clients for an advanced world.</p>
