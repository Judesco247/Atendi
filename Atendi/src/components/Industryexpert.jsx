...
const Industryexpert = () => (
  <div className="mt-10 md:w-[800px] w-[428px] md:h-[200px] h-[722px] md:mb-20">
    ...
    <p className="text-color2 text-[13px] font-bodyfont-400 ">
      ...
      cover every stage of the project life cycle. One of our key strengths is
      our ability to adapt our project management services to suit the unique
      requirements of each project. We understand that no two projects are the
