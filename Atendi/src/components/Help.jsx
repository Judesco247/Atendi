        ...
        <div class="hidden md:flex items-center">
            ...
            <div className='md:w-[620px] w-[380px] md:h-[600px] h-[682px] p-24'>
                ...
                <p className="text-white text-[13px] font-bodyfont-400 pt-5 pb-6">
                    ...
                    and providing seamless integration, we empower you to navigate the complexities of today's business
                    landscape. Our proven track record, customer-centric approach, and commitment to excellence set us
                    apart as your trusted partner. Let's collaborate to unlock your business's full potential and achieve
                    lasting results.
                </p>
