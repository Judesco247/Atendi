  ...
  <div className="container md:w-[1600px] md:h-[800px]">
    <div className="flex md:flex-row flex-cols-2 sm:py-16 py-6">
      <div className="mt-[-20px]">
        <p className='md:ml-12 md:w-[450px] w-[328px] text-background text-[15px] font-bold mb-4 font-bodyfont-400'>Our Journey as a Technology Consulting Company</p>
        <h1 className='md:ml-12 md:w-[600px] w-[328px] text-color1 text-[25px] font-bold mb-4 font-bodyfont-400'>Enhancing Customer Engagement Through Technology</h1>
        <p className="md:ml-12 md:w-[617px] w-[360px] text-color2 md:text-[13px] text-[10px] font-bodyfont-400">Welcome to ATENDI, a leading customer engagement solutions provider. Our mission
