...
const Clients = () => (
  <div class="container mx-auto bg-color0 ">
    <div class="bg-color0">
      ...
      <h1 class="md:w-[914px] w-[267px] md:h-[44px] h-[31px] text-center text-[20px] text-white font-bold font-kollektif-700">Why Choose ATENDI?</h1>
      </div>
      <div className="flex items-center justify-center ">
      <p class="md:w-[950px] w-[380px] md:h-[52px] h-[130px] text-center text-[13px] text-white font-kollektif-700 p-4">With our advanced technological solutions and innovative strategies, ATENDI can provide your business with enhanced communication, increased revenue, streamlined operations, and a competitive advantage. Choose us for results-driven solutions.</p>
      </div>
