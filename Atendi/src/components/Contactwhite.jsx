...
const Contactwhite = () => (
    <div>
        <div class="hidden md:flex mt-20 mb-20">
            <div class="ml-3 p-4">
                <h1 class="text-[30px] text-color9 font-bold font-kollektif-700 mb-4">We’d love to hear from you</h1>
                <p className="text-color9 text-[13px] font-kollektif-700 pb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit vehicula dui sit amet ligula cursus. dolor sit amet dolor adipiscing. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, </p>
                <div className="container mx-auto p-2">
                    <h5 className='text-[20px] text-color9 font-bold font-kollektif-400'>
                        <span><img src={line} alt="bluetick" className="mr-2 mb-2" /></span>
                        Our Location
                    </h5>
                    <p className="text-color2 text-[13px] font-kollektif-400 pt-5">Corporate Headquarters<br />
                        10 Almaden Blvd, Suite 990<br />
                        San Jose, CA 95113 USA</p>
                    <p className="text-color2 text-[13px] font-kollektif-400 pt-5"><span className='text-color9'>Email:</span> info@attendi.com</p>
                    <p className="text-color2 text-[13px] font-kollektif-400 pt-2"><span className='text-color9'>Phone Number:</span> +234 812 345 6789</p>
                </div>
            ...
            <div class="p-4">
                <form>
                    <div className='flex'>
                        <div class="mb-4">
                            <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="fname">First Name</label>
                            <input type="text" id="fname" name="fname" class="w-[270px] border border-gray-400 p-2" placeholder="Enter your name" />
                        </div>
                        <div class="mb-4 ml-3">
                            <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="lname">Last Name</label>
                    ...
                    <div className='flex'>
                        <div class="mb-4">
                            <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="phone">Phone Number</label>
                            <input type="number" id="phone" name="phone" class="w-[270px] border border-gray-400 p-2" placeholder="Enter your name" />
                        </div>
                        <div class="mb-4 ml-3">
                            <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="email">Email</label>
                    ...
                    <div className='flex'>
                        <div class="mb-4">
                            <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="service">Services</label>
                            <input type="text" id="service" name="service" class="w-[270px] border border-gray-400 p-2" placeholder="Enter your name" />
                        </div>
                        <div class="mb-4 ml-3">
                            <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="company">Company Name</label>
                            <input type="text" id="company" name="company" class="w-[270px] border border-gray-400 p-2" placeholder="Enter your email" />
                        </div>
                    </div>

                    <div class="mb-4">
                        <label class="block text-color1 font-bold mb-2 font-kollektif-400" for="message">How can we help?</label>
                    ...
                    <div class="flex flex-col justify-center">
                        <p className='text-color1'>Drag and Drop or <label for="fileInput" class="text-background cursor-pointer">
                            Browse Files
        ...
        <div className="block md:hidden w-[428px] h-[1633px] mt-4">
            <h1 class="text-[24px] w-[365px] h-[31px] text-color9 font-bold font-kollektif-700 mt-8 mb-4">We’d love to hear from you</h1>
            <p className="text-color9 text-[16px] w-[365px] h-[127px] items-center font-kollektif-700 mt-8">Lorem ipsum dolor sit amet,
            ...
            <form className="mt-14">
                ...
                <div class="flex flex-col justify-center">
                    <p className='w-[355px] h-[20px] text-color1'>Drag and Drop or <label for="fileInput" class="text-background cursor-pointer">
                        Browse Files
                    </label> (up to 5 files of 20MB overall)</p>
                    <input id="fileInput" type="file" class="hidden" multiple accept=".jpg, .png" max="5" max-size="20000" />
                    <p id="fileCount" class="mt-2 text-gray-500"></p>
                ...
                <button className="w-[355px] h-[50px] py-3 px-3 text-[13px] font-bold bg-background text-white px-4 py-2 font-kollektif-400">Send Request</button>
            </form>
