      ...
      <div className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        <div className={`${styles.flexStart} md:flex-row flex-col mb-10 w-full`}>
          <div className="flex-[3.0] flex flex-col justify-start mr-[100px] w-full ">
            ...
            <p className={` mt-2 max-w-[470px] text-color2 text-[13px] font-kollektif-700 pt-5 `}>
              ATENDI empowers customer engagement through innovative technology solutions.
              Our services optimize operations, enhance data insights, and create a seamless
              customer experience, helping businesses of all sizes achieve their goals with ease
            </p>
          </div>
          <div className="mr-6 flex-[2.0] mr-8 w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10">
            <div className="flex flex-col ss:my-0 my-4 min-w-[150px]">
              <h4 className="text-[12px] text-color1 font-bold font-kollektif-700">
                {" "}
                COMPANY{" "}
              </h4>
          ...
          <div className="flex-[2.3] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10 ">
            <div className="flex flex-col ss:my-0 my-4 min-w-[150px]">
              ...
              <ul className="list-none mb-4">
                <li
                  className={`text-color2 text-[13px] font-kollektif-700 pt-5 block `}
                >
